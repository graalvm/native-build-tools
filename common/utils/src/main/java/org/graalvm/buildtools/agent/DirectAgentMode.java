...
public class DirectAgentMode implements AgentMode{
    private final List<String> agentCmdLine;

    public DirectAgentMode(List<String> agentCmdLine) {
        this.agentCmdLine = agentCmdLine;
    }
