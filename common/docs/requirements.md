# REQ-common-libraries-no-build-tool-api-dependencies: Common runtime libraries do not depend on Gradle or Maven APIs
...
constrains §AR-common-libraries.5 and supports §GOAL-common-libraries-shared-native-image-semantics.

# REQ-common-libraries-stable-shared-semantics: Shared behavior changes preserve plugin parity
...
This requirement constrains §FS-common-libraries and follows §GOAL-common-libraries-shared-native-image-semantics.

# REQ-common-libraries-version-and-schema-compatibility: Common metadata and schema behavior tracks supported Native Image versions
...
supports §root/REQ-supported-build-tool-and-runtime-version-matrix.
