...
context. Use the repository CI workflows in §root/AR-repository-ci.1.5,
§root/AR-repository-ci.1.6, and §root/AR-repository-ci.1.7 as the merge-gate equivalents.
