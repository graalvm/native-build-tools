...
| Generate resource configuration | [§gradle/FS-resources-metadata](../../../native-gradle-plugin/docs/functional/resources-and-metadata.md#fs-resources-metadata-gradle-tasks-generate-resources-and-consume-reachability-metadata) | [§maven/FS-resources-metadata](../../../native-maven-plugin/docs/functional/resources-and-metadata.md#fs-resources-metadata-maven-goals-generate-resources-and-consume-reachability-metadata) | [§FS-resources-metadata.1](resources-and-metadata.md#1-resource-configuration) |
| Use reachability metadata | [§gradle/FS-resources-metadata](../../../native-gradle-plugin/docs/functional/resources-and-metadata.md#fs-resources-metadata-gradle-tasks-generate-resources-and-consume-reachability-metadata) | [§maven/FS-resources-metadata](../../../native-maven-plugin/docs/functional/resources-and-metadata.md#fs-resources-metadata-maven-goals-generate-resources-and-consume-reachability-metadata) | [§FS-resources-metadata.2](resources-and-metadata.md#2-reachability-metadata-repository) |
| Inspect missing metadata | [§gradle/FS-resources-metadata](../../../native-gradle-plugin/docs/functional/resources-and-metadata.md#fs-resources-metadata-gradle-tasks-generate-resources-and-consume-reachability-metadata) | [§maven/FS-resources-metadata](../../../native-maven-plugin/docs/functional/resources-and-metadata.md#fs-resources-metadata-maven-goals-generate-resources-and-consume-reachability-metadata) | [§FS-resources-metadata.3](resources-and-metadata.md#3-missing-metadata-reports) |
...
- resource configuration generation ([§FS-resources-metadata.1](resources-and-metadata.md#1-resource-configuration))
- reachability metadata repository consumption ([§FS-resources-metadata.2](resources-and-metadata.md#2-reachability-metadata-repository))
- missing metadata reports ([§FS-resources-metadata.3](resources-and-metadata.md#3-missing-metadata-reports))
- dynamic access metadata ([§FS-resources-metadata.4](resources-and-metadata.md#4-dynamic-access-metadata))
...
- schema validation ([§FS-resources-metadata.5](resources-and-metadata.md#5-schema-validation))
