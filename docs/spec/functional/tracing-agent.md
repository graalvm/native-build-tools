...
§gradle/FS-tracing-agent; Maven adapts through §maven/FS-tracing-agent.
...
Plugin-specific configuration names are specified by §gradle/FS-tracing-agent.1 and
...
§gradle/FS-tracing-agent.2, §gradle/FS-tracing-agent.4, and
§maven/FS-tracing-agent.3.
...
Plugin-specific merge and copy entry points are specified by §gradle/FS-tracing-agent.5
and §maven/FS-tracing-agent.4.
