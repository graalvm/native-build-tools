# GRUND-001-native-build-tools-reason-for-existence: Native Build Tools gives JVM projects build-tool-native workflows for GraalVM Native Image
...
§GOAL-001-build-tool-native-image-workflows and the module ownership model in
§REPO-001-module-boundaries.
