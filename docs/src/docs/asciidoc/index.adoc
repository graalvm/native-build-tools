...
- Update plugin to use metadata repository by default. Metadata repository can be disabled manually. <<gradle-plugin.adoc#_configuring_the_metadata_repository,See this>>

==== Maven plugin

- Update plugin to use metadata repository by default. Metadata repository can be disabled manually. <<maven-plugin.adoc#_configuring_the_metadata_repository,See this>>
