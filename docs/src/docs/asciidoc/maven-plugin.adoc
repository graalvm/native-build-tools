...
----
<1> The local path can point to an _exploded_ directory, or to a compressed archive in the following formats: `.zip`, `.tar.gz` or `.tar.bz2`.

Alternatively, you can use a _remote repository_, in which case you can specify the URL of the repository:
