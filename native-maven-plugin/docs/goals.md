...
realizes the repository goal in §GOAL-build-tool-native-image-workflows for Maven and is specified
...
The shared contract is §FS-plugin-common-behavior; Maven-specific adaptation is specified by
