...
| [resources-and-metadata.md](resources-and-metadata.md) | Resource configuration goals, reachability metadata, missing-metadata reports, schema validation, and entry points ([§FS-resources-and-metadata](resources-and-metadata.md#fs-resources-and-metadata-maven-goals-generate-resources-and-consume-reachability-metadata)). |
